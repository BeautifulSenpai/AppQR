...
import com.example.appqr.adapters.NotesAdapter;
...
public class MainActivity extends AppCompatActivity implements NoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView mainAddNoteImage = findViewById(R.id.mainAddNote);
        mainAddNoteImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(
                        new Intent(getApplicationContext(), NoteCreateActivity.class),
